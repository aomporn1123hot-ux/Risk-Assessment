...
document.addEventListener("DOMContentLoaded", () => {
  ...
  window.prevPage = () => { if (currentPageIndex > 0) showPage(currentPageIndex - 1); }

  // ฟังก์ชันสร้างตัวเลือกภาพ
  window.createImageOptions = (containerId, name, count, prefix) => {
  ...
  // เก็บคำตอบ Firebase
  window.collectAnswersForFirebase = () => {
